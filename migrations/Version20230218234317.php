 ...
 */
final class Version20230218234317 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ligne_frais_forfait (visiteur_id VARCHAR(255) NOT NULL, fraisforfait_id VARCHAR(255) DEFAULT NULL, fichefrais_id VARCHAR(255) DEFAULT NULL, quantite VARCHAR(100) DEFAULT NULL, INDEX IDX_BD293ECFCEAFB3F4 (fraisforfait_id), INDEX IDX_BD293ECFD318D763 (fichefrais_id), PRIMARY KEY(visiteur_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

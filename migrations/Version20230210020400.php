 ...
 */
final class Version20230210020400 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fiche_frais (id VARCHAR(255) NOT NULL, visiteur_id VARCHAR(255) NOT NULL, etat_id VARCHAR(255) DEFAULT NULL, nb_justificatifs INT DEFAULT NULL, montant_valide NUMERIC(12, 2) DEFAULT NULL, date_modif DATE DEFAULT NULL, INDEX IDX_5FC0A6A77F72333D (visiteur_id), INDEX IDX_5FC0A6A7D5E86FF (etat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

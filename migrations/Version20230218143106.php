 ...
 */
final class Version20230218143106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ligne_frais_hors_forfait (id INT AUTO_INCREMENT NOT NULL, fichefrais_id VARCHAR(255) DEFAULT NULL, visiteur_id VARCHAR(255) DEFAULT NULL, libelle VARCHAR(100) DEFAULT NULL, date DATE DEFAULT NULL, montant NUMERIC(12, 2) DEFAULT NULL, UNIQUE INDEX UNIQ_EC01626DD318D763 (fichefrais_id), INDEX IDX_EC01626D7F72333D (visiteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

 ...
 */
final class Version20230218150848 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fiche_frais (id VARCHAR(255) NOT NULL, visiteur_id VARCHAR(255) NOT NULL, etat_id VARCHAR(255) DEFAULT NULL, lignefraishorsforfait_id INT DEFAULT NULL, nb_justificatifs INT DEFAULT NULL, montant_valide NUMERIC(12, 2) DEFAULT NULL, date_modif DATE DEFAULT NULL, INDEX IDX_5FC0A6A77F72333D (visiteur_id), INDEX IDX_5FC0A6A7D5E86FF (etat_id), UNIQUE INDEX UNIQ_5FC0A6A7B8A05819 (lignefraishorsforfait_id), PRIMARY KEY(id, visiteur_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ligne_frais_hors_forfait (id INT AUTO_INCREMENT NOT NULL, visiteur_id VARCHAR(255) DEFAULT NULL, libelle VARCHAR(100) DEFAULT NULL, date DATE DEFAULT NULL, montant NUMERIC(12, 2) DEFAULT NULL, INDEX IDX_EC01626D7F72333D (visiteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE fiche_frais ADD CONSTRAINT FK_5FC0A6A7B8A05819 FOREIGN KEY (lignefraishorsforfait_id) REFERENCES ligne_frais_hors_forfait (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fiche_frais DROP FOREIGN KEY FK_5FC0A6A7B8A05819');

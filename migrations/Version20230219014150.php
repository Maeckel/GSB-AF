 ...
 */
final class Version20230219014150 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fiche_frais (id VARCHAR(255) NOT NULL, etat_id VARCHAR(255) DEFAULT NULL, visiteur_id VARCHAR(255) NOT NULL, nb_justificatifs INT DEFAULT NULL, montant_valide NUMERIC(12, 2) DEFAULT NULL, date_modif DATE DEFAULT NULL, INDEX IDX_5FC0A6A7D5E86FF (etat_id), INDEX IDX_5FC0A6A77F72333D (visiteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ligne_frais_forfait (visiteur_id VARCHAR(255) NOT NULL, fraisforfait_id VARCHAR(255) NOT NULL, fichefrais_id VARCHAR(255) NOT NULL, quantite VARCHAR(100) DEFAULT NULL, INDEX IDX_BD293ECF7F72333D (visiteur_id), INDEX IDX_BD293ECFCEAFB3F4 (fraisforfait_id), INDEX IDX_BD293ECFD318D763 (fichefrais_id), PRIMARY KEY(visiteur_id, fraisforfait_id, fichefrais_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ligne_frais_hors_forfait (id INT AUTO_INCREMENT NOT NULL, visiteur_id VARCHAR(255) DEFAULT NULL, fiche_frais_id VARCHAR(255) DEFAULT NULL, libelle VARCHAR(100) DEFAULT NULL, date DATE DEFAULT NULL, montant NUMERIC(12, 2) DEFAULT NULL, INDEX IDX_EC01626D7F72333D (visiteur_id), UNIQUE INDEX UNIQ_EC01626DD94F5755 (fiche_frais_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
